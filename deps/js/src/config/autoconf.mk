...
MOZ_BUILD_ROOT             = /usr/local/moon/deliver/APE_Server/deps/js/src
...
CC_VERSION	= gcc version 4.1.2 20071124 (Red Hat 4.1.2-42)
CXX_VERSION	= gcc version 4.1.2 20071124 (Red Hat 4.1.2-42)
